...
public class WeekHealthAnalyseFragment extends Fragment {
...
//            Entry entry = new Entry(i, (float) 0.72);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Rate rate = new Rate();
        rate.setTime("八月第四周");
        rate.setRate((float) 4/7);
        list.add(rate);
        titles.add("9月第一周");
        Rate rate1 = new Rate();
        rate1.setTime("9月第一周");
        rate1.setRate((float)5/7);
        list.add(rate1);
        titles.add("9月第二周");
        Rate rate2 = new Rate();
        rate2.setTime("9月第二周");
        ...
        name.setText("每周准时服药率图");
        text.setText("  该图反应了您最近四周的及时服药比率，您及时服药比率较高，有益身体恢复，建议您继续保持。");
