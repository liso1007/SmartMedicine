...
public class MonthHealthAnalyseFragment extends Fragment {
    ...
    private void initChart(LineChart lineChart) {
        ...
        xAxis.setValueFormatter(new ValueFormatter() {
            ...
            public String getFormattedValue(float value, AxisBase axis) {
                return titles.get((int) value); //mList为存有月份的集合
            }
        });
        //y轴自定义
...
//            Entry entry = new Entry(i, (float) 0.72);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Rate rate = new Rate();
        rate.setTime("6月");
        rate.setRate((float) 3/7);
        list.add(rate);
        titles.add("7月");
        Rate rate1 = new Rate();
        rate1.setTime("7月");
        rate1.setRate((float)2/7);
        list.add(rate1);
        titles.add("8月");
        Rate rate2 = new Rate();
        rate2.setTime("8月");
        rate2.setRate((float)1/7);
        list.add(rate2);
        titles.add("9月");
        Rate rate3 = new Rate();
        rate3.setTime("9月");
        rate3.setRate((float)5/7);
        list.add(rate3);
